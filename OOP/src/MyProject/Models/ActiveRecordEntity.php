<?php
    ...
    abstract class ActiveRecordEntity{
        ...
        public function save() {
            ...
            if ($this->id !== null) {
              return $this->update($propertiesNames);
            } else {
              return $this->insert($propertiesNames);
            }
        }

        public function update(array $propertiesNames) {
            $column2params = [];
            $params2value = [];
            $index = 1;
            ...
            $db = Db::getInstance();
            return $db->query($sql, $params2value, static::class);
        }

        public function insert(array $propertiesNames) {
